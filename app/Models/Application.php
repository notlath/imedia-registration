...
final class Application {
    ...
    public const TYPES        = array( self::TYPE_OJT, self::TYPE_TRAINER );

    public const STATUSES = array( 'pending', 'reviewed', 'accepted', 'rejected' );
    ...
    public static function paginate( string $type, array $filters, int $page = 1, int $perPage = 25 ): array {
        ...
        $where   = array( 'type = :type', 'deleted_at IS NULL' );
